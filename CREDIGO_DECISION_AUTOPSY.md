...
- **Product ID:** credigo
- **Simulation Version Hash:** df238cdc586ac248
- **Run Mode:** production
- **Personas Simulated:** 15
- **Decision Traces:** 500
- **Confidence Level:** 0.428

---

## 1. One-Line Verdict

Trust collapses when commitment is demanded before trust is established.
...
- 100 decision traces where commitment was requested before any value signal
- 19% terminated at or before Step 1 of those traces terminated
- 0 traces where trust increased after commitment demand without value exposure
- Median commitment delta at this step: 0.498
...
- **Step ID:** Find the Best Credit Card In 60 seconds
- **Step Label:** Landing page
- **Position in Flow:** 1
- **Commitment Delta:** 0.190
- **Exit Probability Gradient:** 0.223
...
Credigo's values fall outside this band, indicating a structurally distinct decision pattern.
...
- **Commitment Level:** 0.522
- **Expected Value Timing:** 5 steps away
- **Perceived Risk:** 0.366

### After

- **Task Framing:** value is too distant to justify commitment
- **Commitment Level:** 0.499
- **Expected Value Timing:** 5 steps away (too far)
- **Perceived Risk:** 0.347
...
- **Why It Repairs Belief Ordering:** Value currently appears 5 steps after commitment is demanded. Moving value earlier repairs the belief ordering: value proof before commitment ask.
...
2. **Condition:** If urgent_need variant shows higher drop rate than price_sensitive variant at the irreversible step
...
- **Least Sensitive Variant:** urgent_need
...
The urgent_need variant survives longer because:
- Urgency compresses acceptable value timing
- Commitment is framed as progress toward relief
- Trust deficit is overridden by goal pressure
