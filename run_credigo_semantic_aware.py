#!/usr/bin/env python3
"""
Run semantic-aware behavioral simulation for Credigo.
"""
...
def main():
    print("\n" + "=" * 80)
    print("🧠 SEMANTIC-AWARE BEHAVIORAL SIMULATION: Credigo.club")
    print("=" * 80)
    ...
    first_step = list(CREDIGO_SS_11_STEPS.values())[0]
    ...
    # Save results
    output_file = "output/credigo_semantic_aware_results.json"
