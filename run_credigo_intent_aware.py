#!/usr/bin/env python3
"""
Run intent-aware behavioral simulation for Credigo.
...
def main():
    print("\n" + "=" * 80)
    print("🧠 INTENT-AWARE BEHAVIORAL SIMULATION: Credigo.club")
    print("=" * 80)
    ...
    # Use fixed global intent for Credigo
    # All users share the same intent: "Give me a credit card recommendation"
    print("\n🎯 Using fixed global intent for Credigo...")
    ...
    print(f"   Commitment Threshold: {CREDIGO_GLOBAL_INTENT.commitment_threshold:.1f}")
    print(f"   Expected Value Type: {CREDIGO_GLOBAL_INTENT.expected_value_type}")
    ...
    analysis = generate_intent_analysis(result_df, CREDIGO_SS_11_STEPS)
    
    # Export artifacts
    print("\n💾 Exporting intent artifacts...")
    artifacts = export_intent_artifacts(result_df, CREDIGO_SS_11_STEPS, output_dir=".")
    ...
    output_file = "output/credigo_intent_aware_results.json"
...
if __name__ == "__main__":
    result_df, analysis, artifacts = main()
